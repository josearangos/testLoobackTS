...
export class CorsaVisionController {
  ...
  async count(
    @param.query.object('where', getWhereSchemaFor(CorsaVision)) where?: Where<CorsaVision>,
  ): Promise<Count> {
  ...
  async find(
    @param.query.object('filter', getFilterSchemaFor(CorsaVision)) filter?: Filter<CorsaVision>,
  ): Promise<CorsaVision[]> {
  ...
  async updateAll(
    @requestBody({
      content: {
        'application/json': {
          schema: getModelSchemaRef(CorsaVision, {partial: true}),
        },
      },
    })
    corsaVision: CorsaVision,
    @param.query.object('where', getWhereSchemaFor(CorsaVision)) where?: Where<CorsaVision>,
  ): Promise<Count> {
